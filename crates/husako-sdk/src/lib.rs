...
pub const TEMPLATE_SIMPLE_ENTRY: &str = include_str!("templates/simple/entry.husako");

pub const TEMPLATE_PROJECT_CONFIG: &str = include_str!("templates/project/husako.toml");
pub const TEMPLATE_PROJECT_ENV_DEV: &str = include_str!("templates/project/env/dev.husako");
...
pub const TEMPLATE_MULTI_ENV_DEV_MAIN: &str = include_str!("templates/multi-env/dev/main.husako");
pub const TEMPLATE_MULTI_ENV_STAGING_MAIN: &str =
    include_str!("templates/multi-env/staging/main.husako");
pub const TEMPLATE_MULTI_ENV_RELEASE_MAIN: &str =
    include_str!("templates/multi-env/release/main.husako");
