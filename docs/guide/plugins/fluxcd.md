...
import { namespace } from "k8s/meta/v1";
...
const release = HelmRelease("ingress-nginx")
  .metadata(namespace("ingress"))
  .sourceRef(helmRepo)
  .chart("ingress-nginx", "4.11.0")
  .interval("1h");

husako.build([helmRepo, release]);
```
